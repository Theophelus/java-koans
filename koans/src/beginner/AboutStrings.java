...
public class AboutStrings {
    ...
    public void stringCompare() {
        String str = "I AM a number ONE!";
        String str2 = "I AM a number ONE!";
        assertEquals(str.compareTo(str2) == 0, true);
        assertEquals(str.compareTo("I am a number one!") == 1, false);
        assertEquals(str.compareTo("I AM A NUMBER ONE!") == 1, false);
    }
    ...
    public void extraArgumentsToStringFormatGetIgnored() {
        assertEquals(String.format("%s %s %s %s", "a", "b", "c", "d"), "a b c d");
    }
