...
public class AboutCasting {
    ...
    public void classCasting() {
        try {
            // Object o = new Object();
            Grandparent o = new Grandparent();// an OBJECT can not be implememted on an INTERFACE.
    ...
    public void complicatedCast() {
        ...
        /*
         * I need to appply upCasting in order to get acce into that complain
         * method in Grandparent Class
         */

        // How can we access the parent's ability to "complain" - if the reference is
        // held as a superclass?
        assertEquals("TPS reports don't even have a cover letter!", getParent.complain());
    }
